...
export default function MainDashboard() {
    ...
    let navigate = useNavigate();
         ...
         const addToFavourite=async(food)=>{
            console.log(localStorage.getItem("id"))
          console.log(food.food.label)
         console.log(food.food.foodId)
         console.log( food.food.nutrients)
          
          
          let response = await axios.post('http://localhost:8080/api/favorite/addToFavorite',
          ({ 
